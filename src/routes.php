...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::put(config('pulsar.appName') . '/pulsar/email/accounts/update/{id}/{offset}',        ['as'=>'updateEmailAccount',        'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@updateRecord',           'resource' => 'admin-email-account',    'action' => 'edit']);
