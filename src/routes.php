...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName').'/pulsar/territorialareas1/{id}/edit/{offset}',                                         ['as'=>'editTerritorialArea1',                  'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas1@editRecord',                           'resource' => 'admin-country-at1',  'action' => 'access']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas1/update/{country}/{offset}',                                 ['as'=>'updateTerritorialArea1',                'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas1@updateRecord',                         'resource' => 'admin-country-at1',  'action' => 'edit']);
    Route::get(config('pulsar.appName').'/pulsar/territorialareas1/delete/{country}/{id}',                                      ['as'=>'deleteTerritorialArea1',                'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas1@deleteRecord',                         'resource' => 'admin-country-at1',  'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas1/delete/select/elements/{country}',                          ['as'=>'deleteSelectTerritorialArea1',          'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas1@deleteRecordsSelect',                  'resource' => 'admin-country-at1',  'action' => 'delete']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName').'/pulsar/territorialareas2/{country}/{offset?}',                                              ['as'=>'TerritorialArea2',                 'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@index',                               'resource' => 'admin-country-at2',             'action' => 'delete']);
    Route::any(config('pulsar.appName').'/pulsar/territorialareas2/json/data/country/{country}',                                      ['as'=>'jsonDataTerritorialArea2',         'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@jsonData',                            'resource' => 'admin-country-at2',             'action' => 'delete']);
    ...
    Route::get(config('pulsar.appName').'/pulsar/territorialareas2/{id}/edit/{offset}',                                               ['as'=>'editTerritorialArea2',             'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@editRecord',                          'resource' => 'admin-country-at2',             'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas2/update/{country}/{offset}',                                       ['as'=>'updateTerritorialArea2',           'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@updateRecord',                        'resource' => 'admin-country-at2',             'action' => 'delete']);
    Route::get(config('pulsar.appName').'/pulsar/territorialareas2/delete/{country}/{id}',                                            ['as'=>'deleteTerritorialArea2',           'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@deleteRecord',                        'resource' => 'admin-country-at2',             'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas2/delete/select/elements/{country}',                                ['as'=>'deleteSelectTerritorialArea2',     'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@deleteRecordsSelect',                 'resource' => 'admin-country-at2',             'action' => 'delete']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName').'/pulsar/territorialareas3/{country}/{offset?}',                                                ['as'=>'TerritorialArea3',              'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@index',                                'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::any(config('pulsar.appName').'/pulsar/territorialareas3/json/data/country/{country}',                                        ['as'=>'jsonDataTerritorialArea3',      'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@jsonData',                             'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::get(config('pulsar.appName').'/pulsar/territorialareas3/create/{country}/{offset}',                                          ['as'=>'createTerritorialArea3',        'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@create',                               'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas3/store/{country}/{offset}',                                          ['as'=>'storeTerritorialArea3',         'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@store',                                'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::get(config('pulsar.appName').'/pulsar/territorialareas3/{id}/edit/{offset}',                                                 ['as'=>'editTerritorialArea3',          'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@edit',                                 'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas3/update/{country}/{offset}',                                         ['as'=>'updateTerritorialArea3',        'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@update',                               'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::get(config('pulsar.appName').'/pulsar/territorialareas3/delete/{country}/{id}',                                              ['as'=>'deleteTerritorialArea3',        'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@delete',                               'resource' => 'admin-country-at3',             'action' => 'delete']);
    Route::post(config('pulsar.appName').'/pulsar/territorialareas3/delete/select/elements/{country}',                                  ['as'=>'deleteSelectTerritorialArea3',  'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@deleteSelect',                         'resource' => 'admin-country-at3',             'action' => 'delete']);
