...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas1/json/data/{country}/{parentOffset}/{offset?}',             ['as'=>'jsonDataTerritorialArea1',              'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@jsonData',                             'resource' => 'admin-country-at1',  'action' => 'access']);
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas1/{country}/{parentOffset}/{offset?}',                       ['as'=>'TerritorialArea1',                      'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@index',                                'resource' => 'admin-country-at1',  'action' => 'access']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas1/create/{country}/{parentOffset}/{offset}',                 ['as'=>'createTerritorialArea1',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@createRecord',                         'resource' => 'admin-country-at1',  'action' => 'create']);
    Route::post(config('pulsar.appName') . '/pulsar/territorialareas1/store/{country}/{parentOffset}/{offset}',                 ['as'=>'storeTerritorialArea1',                 'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@storeRecord',                          'resource' => 'admin-country-at1',  'action' => 'create']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas1/{id}/edit/{country}/{parentOffset}/{offset}',              ['as'=>'editTerritorialArea1',                  'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@editRecord',                           'resource' => 'admin-country-at1',  'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/territorialareas1/update/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'updateTerritorialArea1',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@updateRecord',                         'resource' => 'admin-country-at1',  'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas1/delete/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'deleteTerritorialArea1',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@deleteRecord',                         'resource' => 'admin-country-at1',  'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/territorialareas1/delete/select/records/{country}/{parentOffset}',        ['as'=>'deleteSelectTerritorialArea1',          'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@deleteRecordsSelect',                  'resource' => 'admin-country-at1',  'action' => 'delete']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas2/json/data/{country}/{parentOffset}/{offset?}',             ['as'=>'jsonDataTerritorialArea2',              'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@jsonData',                                  'resource' => 'admin-country-at2',  'action' => 'access']);
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas2/{country}/{parentOffset}/{offset?}',                       ['as'=>'TerritorialArea2',                      'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@index',                                     'resource' => 'admin-country-at2',  'action' => 'access']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas2/create/{country}/{parentOffset}/{offset}',                 ['as'=>'createTerritorialArea2',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@createRecord',                              'resource' => 'admin-country-at2',  'action' => 'create']);
    Route::post(config('pulsar.appName') . '/pulsar/territorialareas2/store/{country}/{parentOffset}/{offset}',                 ['as'=>'storeTerritorialArea2',                 'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@storeRecord',                               'resource' => 'admin-country-at2',  'action' => 'create']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas2/{id}/edit/{country}/{parentOffset}/{offset}',              ['as'=>'editTerritorialArea2',                  'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@editRecord',                                'resource' => 'admin-country-at2',  'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/territorialareas2/update/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'updateTerritorialArea2',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@updateRecord',                              'resource' => 'admin-country-at2',  'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas2/delete/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'deleteTerritorialArea2',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@deleteRecord',                              'resource' => 'admin-country-at2',  'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/territorialareas2/delete/select/records/{country}/{parentOffset}',        ['as'=>'deleteSelectTerritorialArea2',          'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas2@deleteRecordsSelect',                       'resource' => 'admin-country-at2',  'action' => 'delete']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas3/json/data/country/{country}/{parentOffset}/{offset?}',     ['as'=>'jsonDataTerritorialArea3',              'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@jsonData',                                     'resource' => 'admin-country-at3',  'action' => 'access']);
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas3/{country}/{parentOffset}/{offset?}',                       ['as'=>'TerritorialArea3',                      'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@index',                                        'resource' => 'admin-country-at3',  'action' => 'access']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas3/create/{country}/{parentOffset}/{offset}',                 ['as'=>'createTerritorialArea3',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@createRecord',                                 'resource' => 'admin-country-at3',  'action' => 'create']);
    Route::post(config('pulsar.appName') . '/pulsar/territorialareas3/store/{country}/{parentOffset}/{offset}',                 ['as'=>'storeTerritorialArea3',                 'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@storeRecord',                                  'resource' => 'admin-country-at3',  'action' => 'create']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas3/{id}/edit/{country}/{parentOffset}/{offset}',              ['as'=>'editTerritorialArea3',                  'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@editRecord',                                   'resource' => 'admin-country-at3',  'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/territorialareas3/update/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'updateTerritorialArea3',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@updateRecord',                                 'resource' => 'admin-country-at3',  'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/territorialareas3/delete/{country}/{parentOffset}/{id}/{offset}',            ['as'=>'deleteTerritorialArea3',                'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@deleteRecord',                                 'resource' => 'admin-country-at3',  'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/territorialareas3/delete/select/records/{country}/{parentOffset}',        ['as'=>'deleteSelectTerritorialArea3',          'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas3@deleteRecordsSelect',                          'resource' => 'admin-country-at3',  'action' => 'delete']);
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName').'/pulsar/email/accounts/{offset?}',                 ['as'=>'EmailAccount',              'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@index',                  'resource' => 'admin-email-account',    'action' => 'access']);
    Route::any(config('pulsar.appName').'/pulsar/email/accounts/json/data',                 ['as'=>'jsonDataEmailAccount',      'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@jsonData',               'resource' => 'admin-email-account',    'action' => 'access']);
    Route::get(config('pulsar.appName').'/pulsar/email/accounts/create/{offset}',           ['as'=>'createEmailAccount',        'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@createRecord',           'resource' => 'admin-email-account',    'action' => 'create']);
    Route::post(config('pulsar.appName').'/pulsar/email/accounts/store/{offset}',           ['as'=>'storeEmailAccount',         'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@storeRecord',            'resource' => 'admin-email-account',    'action' => 'create']);
    Route::get(config('pulsar.appName').'/pulsar/email/accounts/{id}/edit/{offset}',        ['as'=>'editEmailAccount',          'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@editRecord',             'resource' => 'admin-email-account',    'action' => 'access']);
    Route::post(config('pulsar.appName').'/pulsar/email/accounts/update/{id}/{offset}',     ['as'=>'updateEmailAccount',        'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@updateRecord',           'resource' => 'admin-email-account',    'action' => 'edit']);
    ...
    Route::post(config('pulsar.appName').'/pulsar/email/accounts/delete/select/records',    ['as'=>'deleteSelectEmailAccount',  'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@deleteRecordsSelect',    'resource' => 'admin-email-account',    'action' => 'delete']);
    Route::get(config('pulsar.appName').'/pulsar/email/accounts/{id}/review/{offset}',      ['as'=>'reviewEmailAccount',        'uses'=>'Syscover\Pulsar\Controllers\EmailAccounts@reviewXX',                 'resource' => 'admin-email-account',    'action' => 'access']);
