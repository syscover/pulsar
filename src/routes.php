...
Route::group(['middleware' => ['web']], function() {
    ...
    |--------------------------------------------------------------------------
    */
    Route::get(config('pulsar.appName') . '/pulsar/dashboard',                          ['middleware' => 'pulsar.auth',         'as' => 'dashboard', 'uses' => 'Syscover\Pulsar\Controllers\DashboardController@index',                          'resource' => 'admin-dashboard']);
...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/pulsar/testing',                                    ['as' => 'testing',                'uses' => 'Syscover\Pulsar\Controllers\TestingController@testing']);
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/pulsar/reports/download/{filename}/{token}',        ['as' => 'downloadReportTask',      'uses' => 'Syscover\Pulsar\Controllers\DownloadController@downloadAReportTask']);
