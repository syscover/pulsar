...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::any(config('pulsar.appName') . '/pulsar/territorialareas1/json/data/{country}/{offset?}',                  ['as'=>'jsonDataTerritorialArea1',              'uses'=>'Syscover\Pulsar\Controllers\TerritorialAreas1@jsonData',                             'resource' => 'admin-country-at1',  'action' => 'access']);
