...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/pulsar/custom/field/families/{id}/edit/{offset}',         ['as'=>'editCustomFieldFamily',            'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@editRecord',                'resource' => 'admin-field-family',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/custom/field/families/update/{id}/{offset}',       ['as'=>'updateCustomFieldFamily',          'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@updateRecord',              'resource' => 'admin-field-family',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/field/families/delete/{id}/{offset}',       ['as'=>'deleteCustomFieldFamily',          'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@deleteRecord',              'resource' => 'admin-field-family',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/custom/field/families/delete/select/records',   ['as'=>'deleteSelectCustomFieldFamily',    'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@deleteRecordsSelect',       'resource' => 'admin-field-family',        'action' => 'delete']);
    Route::any(config('pulsar.appName') . '/pulsar/custom/field/families/{id}/show/{api}',            ['as'=>'apiShowCustomFieldFamily',         'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@showRecord',                'resource' => 'admin-field-family',        'action' => 'access']);
