...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/pulsar/custom/fields/families/{offset?}',                  ['as'=>'customFieldFamily',                'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@index',                     'resource' => 'admin-field-family',        'action' => 'access']);
    Route::any(config('pulsar.appName') . '/pulsar/custom/fields/families/json/data',                  ['as'=>'jsonDataCustomFieldFamily',        'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@jsonData',                  'resource' => 'admin-field-family',        'action' => 'access']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/families/create/{offset}',            ['as'=>'createCustomFieldFamily',          'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@createRecord',              'resource' => 'admin-field-family',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/pulsar/custom/fields/families/store/{offset}',            ['as'=>'storeCustomFieldFamily',           'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@storeRecord',               'resource' => 'admin-field-family',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/families/{id}/edit/{offset}',         ['as'=>'editCustomFieldFamily',            'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@editRecord',                'resource' => 'admin-field-family',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/custom/fields/families/update/{id}/{offset}',       ['as'=>'updateCustomFieldFamily',          'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@updateRecord',              'resource' => 'admin-field-family',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/families/delete/{id}/{offset}',       ['as'=>'deleteCustomFieldFamily',          'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@deleteRecord',              'resource' => 'admin-field-family',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/custom/fields/families/delete/select/records',   ['as'=>'deleteSelectCustomFieldFamily',    'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@deleteRecordsSelect',       'resource' => 'admin-field-family',        'action' => 'delete']);
    Route::any(config('pulsar.appName') . '/pulsar/custom/fields/families/{id}/show/{api}',            ['as'=>'apiShowCustomFieldFamily',         'uses'=>'Syscover\Pulsar\Controllers\CustomFieldFamilyController@showRecord',                'resource' => 'admin-field-family',        'action' => 'access']);
    ...
    */
    ...
    Route::post(config('pulsar.appName') . '/pulsar/custom/fields/values/store/{lang}/{offset}/{id?}',                 ['as'=>'storeCustomFieldValue',               'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@storeRecord',                'resource' => 'admin-field-value',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/values/{id}/edit/{lang}/{offset}',                    ['as'=>'editCustomFieldValue',                'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@editRecord',                 'resource' => 'admin-field-value',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/pulsar/custom/fields/values/update/{lang}/{id}/{offset}',                  ['as'=>'updateCustomFieldValue',              'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@updateRecord',               'resource' => 'admin-field-value',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/values/delete/{lang}/{id}/{offset}',                  ['as'=>'deleteCustomFieldValue',              'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@deleteRecord',               'resource' => 'admin-field-value',        'action' => 'delete']);
    Route::get(config('pulsar.appName') . '/pulsar/custom/fields/values/delete/translation/{lang}/{id}/{offset}',      ['as'=>'deleteTranslationCustomFieldValue',   'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@deleteTranslationRecord',    'resource' => 'admin-field-value',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/pulsar/custom/fields/values/delete/select/records/{lang}',              ['as'=>'deleteSelectCustomFieldValue',        'uses'=>'Syscover\Pulsar\Controllers\CustomFieldValueController@deleteRecordsSelect',        'resource' => 'admin-field-value',        'action' => 'delete']);
