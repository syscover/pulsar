...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar']], function() {
    ...
    */
    ...
    Route::put(config('pulsar.appName').'/pulsar/territorialareas2/update/{country}/{offset}',                                          ['as'=>'updateTerritorialArea2',           'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas2@updateRecord',                        'resource' => 'admin-country-at2',             'action' => 'delete']);
    ...
    */
    ...
    Route::put(config('pulsar.appName').'/pulsar/territorialareas3/update/{country}/{offset}',                                          ['as'=>'updateTerritorialArea3',        'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@update',                               'resource' => 'admin-country-at3',             'action' => 'delete']);
    ...
    Route::delete(config('pulsar.appName').'/pulsar/territorialareas3/delete/select/records/{country}',                                 ['as'=>'deleteSelectTerritorialArea3',  'uses'=>'Pulsar\Pulsar\Controllers\TerritorialAreas3@deleteSelect',                         'resource' => 'admin-country-at3',             'action' => 'delete']);
