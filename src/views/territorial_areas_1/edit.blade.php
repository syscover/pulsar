...
<li class="current">
    <a href="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales1/{{ $pais->id_002 }}" title=""><?php echo $pais->area_territorial_1_002; ?></a>
</li>
@stop
    ...
    <div class="col-md-12">
        <div class="widget box">
            ...
            <div class="widget-content">
                <form class="form-horizontal" method="post" action="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales1/update/{{ $pais->id_002 }}/{{ $inicio }}">
                    {{ Form::token() }}
