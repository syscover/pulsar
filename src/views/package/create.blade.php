...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans('pulsar::pulsar.folder'), 'name' => 'folder', 'value' => Input::old('folder'), 'maxLength' => '50', 'rangeLength' => '2,50', 'required' => true])
