<li{!! Miscellaneous::setCurrentOpenPage(['admin-user', 'admin-lang', 'admin-country', 'admin-country-at1', 'admin-country-at2', 'admin-country-at3', 'admin-package', 'admin-cron', 'admin-perm-profile', 'admin-perm-resource', 'admin-perm-action', 'admin-perm-perm', 'admin-email-account', 'admin-attachment-family', 'admin-attachment-mime', 'admin-attachment-library','admin-field', 'admin-field-value', 'admin-field-group']) !!}>
    ...
    <ul class="sub-menu">
        ...
        @endif
        @if(session('userAcl')->allows('admin-lang', 'access'))
        ...
        @endif
        @if(session('userAcl')->allows('admin-cron', 'access'))
        ...
        @endif
        @if(session('userAcl')->allows('admin-email-account', 'access'))
        ...
        @if(session('userAcl')->allows('admin-field', 'access'))
            <li{!! Miscellaneous::setOpenPage(['admin-field', 'admin-field-value', 'admin-field-group']) !!}>
        ...
        @endif
        @if(session('userAcl')->allows('admin-perm', 'access'))
            <li{!! Miscellaneous::setOpenPage(['admin-perm-profile', 'admin-perm-resource', 'admin-perm-action', 'admin-perm-profile', 'admin-perm-perm']) !!}>
                ...
                <ul class="sub-menu"{!! Miscellaneous::setDisplayPage(['admin-perm-resource', 'admin-perm-action', 'admin-perm-profile', 'admin-perm-perm']) !!}>
                    @if(session('userAcl')->allows('admin-perm-profile', 'access'))
                    ...
                    @endif
                    @if(session('userAcl')->allows('admin-perm-resource', 'access'))
                    ...
                    @endif
                    @if(session('userAcl')->allows('admin-perm-action', 'access'))
