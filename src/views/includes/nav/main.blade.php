<li{!! is_current_resource(['admin-user', 'admin-report','admin-lang', 'admin-country', 'admin-country-at1', 'admin-country-at2', 'admin-country-at3', 'admin-package', 'admin-cron', 'admin-perm-profile', 'admin-perm-resource', 'admin-perm-action', 'admin-perm-perm', 'admin-email-account', 'admin-attachment-family', 'admin-attachment-mime', 'admin-attachment-library','admin-field', 'admin-field-value', 'admin-field-group']) !!}>
    ...
    <ul class="sub-menu">
        ...
        @if(is_allowed('admin-country', 'access'))
            <li{!! is_current_resource(['admin-country','admin-country-at1','admin-country-at2','admin-country-at3']) !!}><a href="{{ route('country', [base_lang2()->id_001]) }}"><i class="fa fa-globe"></i>{{ trans_choice('pulsar::pulsar.country', 2) }}</a></li>
        @endif
        ...
        @if(is_allowed('admin-field', 'access'))
            <li{!! is_current_resource(['admin-field', 'admin-field-value', 'admin-field-group'], true) !!}>
                ...
                <ul class="sub-menu">
                    @if(is_allowed('admin-field', 'access'))
                        <li{!! is_current_resource(['admin-field', 'admin-field-value']) !!}><a href="{{ route('customField', [base_lang2()->id_001]) }}"><i class="fa fa-i-cursor"></i>{{ trans_choice('pulsar::pulsar.field', 2) }}</a></li>
                    @endif
