<div class="form-group">
    ...
    <div class="col-md-{{ $iconSize or 2 }}">
        <a href="{{ $modalUrl }}" class="magnific-popup" data-original-title="Seleccionar un cliente"><span class="icomoon-icon-plus"></span></a>
        <input type="hidden" name="{{ $name.'id' }}" value="{{ isset($valueId)? $valueId : null }}">
    </div>
</div>