...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => 'ID', 'name' => 'id', 'value' => Input::old('id', isset($object->id_002)? $object->id_002 : null), 'maxLength' => '2', 'size' => '2', 'required' => true, 'fieldSize' => 2, 'readOnly' => $lang->id_001 == session('baseLang')->id_001? false : true])
