...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('pulsar::pulsar.field_type', 1), 'name' => 'fieldType', 'value' => $object->field_type_026, 'required' => true, 'objects' => $fieldTypes, 'idSelect' => 'id', 'nameSelect' => 'name', 'class' => 'form-control', 'fieldSize' => 5])
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('pulsar::pulsar.data_type', 1), 'name' => 'dataType', 'value' => $object->data_type_026, 'required' => true, 'objects' => $dataTypes, 'idSelect' => 'id', 'nameSelect' => 'name', 'class' => 'form-control', 'fieldSize' => 5])
