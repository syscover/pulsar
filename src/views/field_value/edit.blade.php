...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans_choice('pulsar::pulsar.name', 1), 'name' => 'name', 'value' => $object->name_027, 'maxLength' => '255', 'rangeLength' => '1,255', 'required' => true])
