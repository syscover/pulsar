...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans_choice('pulsar::pulsar.family', 1), 'name' => 'family', 'value' => $object->family_026, 'required' => true, 'objects' => $families, 'idSelect' => 'id_025', 'nameSelect' => 'name_025', 'class' => 'select2', 'fieldSize' => 5 , 'data' => ['language' => config('app.locale'), 'width' => '100%', 'error-placement' => 'select2-section-outer-container']])
