...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => $country->territorial_area_2_002, 'name' => 'territorialArea2', 'value' => Input::old('territorialArea2'), 'fieldSize' => 6, 'objects' => $territorialAreas2, 'idSelect' => 'id_004', 'nameSelect' => 'name_004', 'required' => true])
