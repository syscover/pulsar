...
<li class="current">
    <a href="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales3/{{ $pais->id_002 }}" title=""><?php echo $pais->area_territorial_3_002; ?></a>
</li>
@stop
    ...
    <div class="col-md-12">
        <div class="widget box">
            ...
            <div class="widget-content">
                <form class="form-horizontal" method="post" action="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales3/store/{{ $pais->id_002 }}/{{ $inicio }}">
                    {{ Form::token() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <select class="form-control" name="areaTerritorial2" notequal="null">
                                ...
                                <option value="<?php echo $areaTerritorial2->id_004 ?>" <?php if(Input::old('areaTerritorial2') == $areaTerritorial2->id_004) echo 'selected=""'; ?>><?php echo $areaTerritorial2->nombre_004 ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-actions">
                        ...
                        <a class="btn btn-inverse" href="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales3/{{ $pais->id_002 }}/{{ $inicio }}">{{ Lang::get('pulsar::pulsar.cancelar') }}</a>
                    </div>
                </form>
            </div>
        </div>
