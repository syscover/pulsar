    ...
    <div class="col-md-12">
        <div class="widget box">
            ...
            <div class="widget-content">
                <form class="form-horizontal" method="post" action="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/cron/jobs/store/{{ $inicio }}">
                    {{ Form::token() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control required" type="text" name="nombre" value="{{ Input::old('nombre') }}" maxlength="50" rangelength="2, 100">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control required" type="text" name="cronExpresion" value="<?php echo Input::old('cronExpresion'); ?>" maxlength="255" rangelength="9, 255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="uniform" type="checkbox" name="activa" value="1"  <?php if(Input::old('activa')) echo 'checked=""'; ?>>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Key <span class="required">*</span></label>
                        <div class="col-md-10">
                            <input class="form-control required" type="text" name="key" value="<?php echo Input::old('key'); ?>" maxlength="50" rangelength="1, 50">
