@extends('pulsar::layouts.form', ['object' => trans_choice('pulsar::pulsar.cronjob', 1), 'action' => 'store'])

@section('rows')
    <!-- pulsar::cron_jobs.crete -->
    @include('pulsar::common.block.block_form_text_group', ['label' => 'ID', 'name' => 'id', 'sizeField' => 2, 'readOnly' => true])
