<div{!! isset($wrapperId)? ' id="' . $wrapperId . '"' : null !!} class="form-group">
    ...
    <div class="col-md-{{ $sizeField or 2 }}">
        <select class="form-control{{ isset($required)? ' required' : null }}{{ isset($class)? ' ' . $class : null }}" name="{{ $name }}"{!! isset($required)? ' notequal="null"' : null !!}{!! isset($data)? Miscellaneous::setDataAttributes($data) : null !!}>
