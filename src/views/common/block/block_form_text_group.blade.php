<div class="form-group">
    ...
    <div class="col-md-{{ $sizeField or 10 }}">
        <input class="form-control{{ isset($required)? ' required' : null }}" type="text" name="{{ $name }}" value="{{ isset($value)? $value : null }}" @if(isset($maxlength)) maxlength="{{ $maxlength }}"@endif @if(isset($maxlength))rangelength="{{ $rangelength }}"@endif{{ isset($readonly)? ' readonly' : null }}>
