...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_secure'), 'name' => 'outgoingSecure', 'value' => Input::old('outgoingSecure'), 'objects' => $outgoingSecures, 'idSelect' => 'id', 'nameSelect' => 'name', 'fieldSize' => 5])
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_type'), 'name' => 'incomingType', 'value' => Input::old('incomingType'), 'objects' => $incomingTypes, 'idSelect' => 'id', 'nameSelect' => 'name', 'fieldSize' => 5])
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_secure'), 'name' => 'incomingSecure', 'value' => Input::old('incomingSecure'), 'objects' => $incomingSecures, 'idSelect' => 'id', 'nameSelect' => 'name', 'fieldSize' => 5])
