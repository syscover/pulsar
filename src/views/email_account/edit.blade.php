...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_secure'), 'name' => 'outgoingSecure', 'value' => $object->outgoing_secure_013, 'objects' => $outgoingSecures, 'idSelect' => 'id', 'nameSelect' => 'name', 'class' => 'form-control', 'fieldSize' => 5])
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_type'), 'name' => 'incomingType', 'value' => $object->incoming_type_013, 'objects' => $incomingTypes, 'idSelect' => 'id', 'nameSelect' => 'name', 'class' => 'form-control', 'fieldSize' => 5])
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_secure'), 'name' => 'incomingSecure', 'value' => $object->incoming_secure_013, 'objects' => $incomingSecures, 'idSelect' => 'id', 'nameSelect' => 'name', 'class' => 'form-control', 'fieldSize' => 5])
