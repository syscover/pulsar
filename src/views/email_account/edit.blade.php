...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('pulsar::pulsar.incoming_secure'), 'name' => 'outgoingSecure', 'value' => $object->outgoing_secure_013, 'objects' => $outgoingSecures, 'idSelect' => 'id', 'nameSelect' => 'name', 'fieldSize' => 5])
