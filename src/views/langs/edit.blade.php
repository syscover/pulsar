...
@section('rows')
    <!-- pulsar::langs.crete -->
    @include('pulsar::common.block.block_form_text_group', ['label' => 'ID', 'name' => 'id', 'oldName' => 'idOld', 'value' => $object->id_001, 'maxLength' => '2', 'rangeLength' => '2,2', 'required' => true, 'sizeField' => 2])
    ...
    [
        ...
        'dirname' => '/packages/pulsar/pulsar/storage/langs/',
