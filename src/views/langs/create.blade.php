...
@section('rows')
    <!-- pulsar::langs.create -->
    @include('pulsar::common.block.block_form_text_group', ['label' => 'ID', 'name' => 'id', 'value' => Input::old('id'), 'maxLength' => '2', 'size' => '2', 'required' => true, 'fieldSize' => 2])
    ...
    @include('pulsar::common.block.block_form_text_group', ['label' => trans('pulsar::pulsar.sorting'), 'name' => 'sorting', 'value' => Input::old('sorting'), 'maxLength' => '3', 'rangeLength' => '1,3', 'min' => '0', 'fieldSize' => 2])
