...
@section('breadcrumbs')
<li>
    <a href="javascript:void(0);">{{ trans('pulsar::pulsar.administracion' )}}</a>
</li>
<li class="current">
    <a href="{{ url(config('pulsar.appName')) }}/pulsar/resources">Resursos</a>
</li>
@stop
...
<div class="row">
    <div class="col-md-12">
        <a class="btn marginB10" href="{{ url(config('pulsar.appName') . '/pulsar/resource/create/' . $offset) }}"><i class="icomoon-icon-database"></i> Nuevo recurso</a>
        <div class="widget box">
            ...
            <div class="widget-content no-padding">
                <form id="formView" method="post" action="{{ url(config('pulsar.appName')) }}/pulsar/recursos/destroy/select/elements">
