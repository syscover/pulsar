...
<div class="row">
    <div class="col-md-12">
        <a class="btn marginB10" href="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales2/create/{{ $pais->id_002 }}/{{ $inicio }}"><i class="entypo-icon-globe"></i> Nuevo/a <?php echo $pais->area_territorial_2_002; ?></a>
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i> <?php echo $pais->area_territorial_2_002; ?> (<?php echo $pais->nombre_002; ?>)</h4>
            ...
            <div class="widget-content no-padding">
                <form id="formView" method="post" action="{{ URL::to(Config::get('pulsar::pulsar.rootUri')) }}/pulsar/areasterritoriales2/destroy/select/elements/{{ $pais->id_002 }}">
