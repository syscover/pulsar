...
<div class="row">
    <div class="col-md-12">
        <a class="btn marginB10" href="{{ url(config('pulsar.appName')) }}/pulsar/areasterritoriales2/create/{{ $pais->id_002 }}/{{ $offset }}"><i class="entypo-icon-globe"></i> Nuevo/a <?php echo $pais->area_territorial_2_002; ?></a>
        <div class="widget box">
            ...
            <div class="widget-content no-padding">
                <form id="formView" method="post" action="{{ url(config('pulsar.appName')) }}/pulsar/areasterritoriales2/destroy/select/elements/{{ $pais->id_002 }}">
