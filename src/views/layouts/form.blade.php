                ...
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="{{ route($action . $routeSuffix, $offset) }}" @if(isset($enctype) && $enctype)enctype="multipart/form-data"@endif>
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn btn-danger marginL10" href="javascript:deleteLangElement('<?php echo $lang->id_002;?>','<?php echo $lang->id_001;?>','<?php echo $offset;?>')">{{ trans('pulsar::pulsar.delete_translation') }}</a>
                            @endif
                        </div>
                    </form>
                </div>
