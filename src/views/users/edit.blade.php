...
@section('rows')
    <!-- pulsar::users.edit -->
    @include('pulsar::common.block.block_form_text_group', ['label' => 'ID', 'name' => 'id', 'value' => $object->id_010, 'readOnly' => true, 'fieldSize' => 2])
    ...
    @include('pulsar::common.block.block_form_text_group', ['label' => trans('pulsar::pulsar.email'), 'name' => 'email', 'value' => $object->email_010, 'maxLength' => '50', 'rangeLength' => '2,50', 'fieldSize' => 6, 'required' => true])
    ...
    @include('pulsar::common.block.block_form_text_group', ['label' => trans_choice('pulsar::pulsar.user', 1), 'name' => 'user', 'value' => $object->user_010, 'maxLength' => '50', 'rangeLength' => '2,50', 'fieldSize' => 6, 'required' => true])
    @include('pulsar::common.block.block_form_password_group', ['label' => trans('pulsar::pulsar.password'), 'name' => 'password', 'maxLength' => '50', 'rangeLength' => '4,50', 'fieldSize' => 6, 'required' => false])
    @include('pulsar::common.block.block_form_password_group', ['label' => trans('pulsar::pulsar.repeat_password'), 'name' => 'repassword', 'maxLength' => '50', 'rangeLength' => '4,50', 'fieldSize' => 6, 'required' => false])
    <!-- /pulsar::users.edit -->
@stop