	...
	public function up()
	{
		if(! Schema::hasTable('001_009_permission'))
		{
			Schema::create('001_009_permission', function (Blueprint $table) {
				...
				$table->foreign('profile_id_009', 'fk01_001_009_permission')->references('id_006')->on('001_006_profile')
					->onDelete('cascade')->onUpdate('cascade');
				$table->foreign('resource_id_009', 'fk02_001_009_permission')->references('id_007')->on('001_007_resource')
					->onDelete('cascade')->onUpdate('cascade');
