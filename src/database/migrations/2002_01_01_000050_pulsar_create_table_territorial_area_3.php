	...
	public function up()
	{
		if(! Schema::hasTable('001_005_territorial_area_3'))
		{
			Schema::create('001_005_territorial_area_3', function (Blueprint $table) {
				...
				$table->foreign('country_id_005', 'fk01_001_005_territorial_area_3')
					->references('id_002')
					->on('001_002_country')
					->onDelete('restrict')
					->onUpdate('cascade');
				$table->foreign('territorial_area_1_id_005', 'fk02_001_005_territorial_area_3')
					->references('id_003')
					->on('001_003_territorial_area_1')
					->onDelete('restrict')
					->onUpdate('cascade');
				$table->foreign('territorial_area_2_id_005', 'fk03_001_005_territorial_area_3')
					->references('id_004')
