...
return array(
	...
	*/
	...
	"between"          => array(
		...
		"string"   => "El campo :attribute debe tener entre :min - :max carácteres.",
	),
	...
	"not_in"           => "El campo :attribute tiene un valor inválido.",
    ...
    "cron_expression"  => "La expresión cron no es válida",
