...
class AreasTerritoriales3 extends BaseController {
    ...
    public function index($pais, $inicio=0){
        ...
        return View::make('pulsar::pulsar.pulsar.areas_territoriales_3.index',$data);
    }
    ...
    public function create($pais, $inicio=0){
        ...
        return View::make('pulsar::pulsar.pulsar.areas_territoriales_3.create',$data);
    }
    ...
    public function edit($id, $inicio=0){
        ...
        return View::make('pulsar::pulsar.pulsar.areas_territoriales_3.edit',$data);
    }
