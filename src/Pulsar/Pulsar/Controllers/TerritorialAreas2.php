...
class AreasTerritoriales2 extends BaseController {
    ...
    public function store($pais, $inicio=0){
        ...
        if ($validation->fails())
        {
            return Redirect::route('createAreasTerritoriales2',array($pais, $inicio))->withErrors($validation)->withInput();
        }
        else
        {
            ...
            return Redirect::route('areasTerritoriales2',array($pais, $inicio));
        }
    }
    ...
    public function update($pais, $inicio=0){
        ...
        if ($validation->fails())
        {
            return Redirect::route('editAreasTerritoriales2',array(Input::get('idOld'), $inicio))->withErrors($validation);
        }
        else
        {
