...
(function ($) {
  ...
  $.FroalaEditor.PLUGINS.imageManager = function (editor) {
    ...
    function _deleteImage (e) {
      ...
      // TODO
      /*if ($.Editable.LANGS[this.opts.language]) {
        message = $.Editable.LANGS[this.opts.language].translation[message];
      }*/
    ...
    function _showImagesByTags() {
      ...
      if ($tags.length > 0) {
        // Hide all images.
        $media_files.find('img').parent().hide();
