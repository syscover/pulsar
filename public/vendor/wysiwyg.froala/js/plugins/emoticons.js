...
(function ($) {
  ...
  $.extend($.FroalaEditor.DEFAULTS, {
    ...
    emoticonsIframeStyle: 'body span.fr-emoticon{font-weight: normal;font-family: "Apple Color Emoji","Segoe UI Emoji","NotoColorEmoji","Segoe UI Symbol","Android Emoji","EmojiSymbols";}'
  });
  ...
  $.FroalaEditor.PLUGINS.emoticons = function (editor) {
    ...
    function insert (emoticon) {
      // Insert emoticon.
      editor.html.insert('<span class="fr-emoticon" contenteditable="false">' + emoticon + '</span>');
    ...
    function _init () {
      ...
      if (editor.opts.iframe) {
        editor.events.on('html.set', function () {
          editor.core.injectStyle(editor.opts.emoticonsIframeStyle);
        });
        editor.core.injectStyle(editor.opts.emoticonsIframeStyle);
      }
    }
